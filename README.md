...
1. Define scraping rules (search terms, product types, keywords) - you can either type in the scraping rules in the table or upload a csv in the format of the sample [here](digitalcamera_st1.csv)
